...
$(".Taj-Mahal3").append('<br>')
$(".Taj-Mahal3").append('<br>')
$(".Taj-Mahal3").append('<img id="taj6" src="https://whc.unesco.org/uploads/thumbs/site_0252_0030-360-360-20131015115527.jpg"/>')
$(".Taj-Mahal3").append('<br>')
$(".Taj-Mahal3").append('<br>')
$(".Taj-Mahal3").append('<br>')
...
$(".the-great-wall").append('<br>')
$(".the-great-wall").append('The Great Wall of China is an ancient series of walls and fortifications, totaling more than 13,000 miles in length, located in northern China. Perhaps the most recognizable symbol of China and its long and vivid history, the Great Wall was originally conceived by Emperor Qin Shi Huang in the third century B.C. as a means of preventing incursions from barbarian nomads. The best-known and best-preserved section of the Great Wall was built in the 14th through 17th centuries A.D., during the Ming dynasty. Though the Great Wall never effectively prevented invaders from entering China, it came to function as a powerful symbol of Chinese civilization enduring strength.')
$(".the-great-wall").append('<br>')
